...
namespace InGame.OutGame.Score
{
    public class ScoreSceneBehaviour:MonoBehaviour,IDisposable
    {
        ...
        private void ExecuteScoreAnimation()
        {
            ...
            DOTween.Sequence()
                //MEMO: 基礎スコアカウント
                .Append(DOTween.To(() => _scoreUpCount, SetScoreView, _score, scoreSceneData.ScoreCountUpDuration))
                ...
                .Append(DOTween.To(() => _scoreUpCount, SetScoreView, bonusAddedScore,
