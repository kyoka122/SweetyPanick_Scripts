...
namespace OutGame.PlayerCustom.MyInput
{
    ...
    public abstract class BaseCaseUnknownControllerInput:IDisposable
    {
        public abstract MyInputDeviceType DeviceType { get; }
        ...
        protected const float SelectorCanMoveStickValue = 0.7f;
        protected const float SelectorNotMoveStickValue = 0.3f;
        
        protected BaseCaseUnknownControllerInput()
        {
        ...
        //TODO: BaseCaseUnknownControllerInputにBasePlayerInputが依存しないコードを書きたい…
        public abstract BasePlayerInput GetInGamePlayerInput();
        
        public virtual BaseCaseUnknownControllerInput Clone()
        {
            return MemberwiseClone() as BaseCaseUnknownControllerInput;
        }
