...
namespace InGame.MyCamera.Installer
{
    public class CameraInstaller
    {
        ...
        /// <returns></returns>
        public CameraController InstallMoveCamera(InGameDatabase inGameDatabase,CommonDatabase commonDatabase,CinemachineTargetGroup targetGroup,Camera camera)
        {
            ...
            cameraView.Init(targetGroup,camera);
