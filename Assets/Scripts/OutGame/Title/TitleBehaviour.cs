...
namespace OutGame.Title
{
    public class TitleBehaviour:MonoBehaviour,IDisposable
    {
        ...
        [SerializeField] private GameObject creditKeyTextObj;
        [SerializeField] private GameObject backKeyTextObj;
        ...
        public void Init(Action toNextSceneEvent,OutGameDatabase outGameDatabase)
        {
            ...
            backKeyTextObj.SetActive(false);
            creditKeyTextObj.SetActive(true);
                ...
                .Subscribe(_ =>
                {
                    if (_isOnCredit)
                    {
                        float nextScrollVarValue = creditScrollVar.value +
                                                   _allTalkInputObserver.OnChangeScrollCreditValue * 
                                                   _outGameDatabase.GetTitleSceneScriptableData().CreditScrollFactor;
        ...
        private async void PopUpCredit()
        {
            ...
            backKeyTextObj.SetActive(true);
            creditKeyTextObj.SetActive(false);
